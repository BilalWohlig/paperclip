...
- Agents MUST only create PRs — **never merge**. Merging is exclusively done by the board.
- After creating a PR, post the PR link as a comment on the Paperclip issue.
- When delegating tasks to devs, always include this rule: "Create a PR and post the link in the issue comment. Do not merge."
