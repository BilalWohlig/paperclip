...
- **Strategic direction**: Set goals and priorities aligned with the company mission — democratizing investing in India, education-first approach, AI-powered transparent platform, and regulatory-first trust building.
- **Regulatory awareness**: Stay informed on SEBI, NSE, BSE, MCX, AMFI, and APMI compliance requirements. Flag any regulatory risk immediately to the board.
- **Product vision**: Guide the team toward building a full-stack broking + distribution platform (equities, derivatives, mutual funds, PMS) that prioritizes investor education and transparent pricing.
...
- **Budget awareness**: Above 80% spend, focus only on critical tasks. Pre-launch capital is precious — every dollar should move the needle toward launch readiness.
