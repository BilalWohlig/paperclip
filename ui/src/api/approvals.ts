...
export const approvalsApi = {
  ...
  approve: (id: string, decisionNote?: string, additionalBudgetCents?: number) =>
    api.post<Approval>(`/approvals/${id}/approve`, {
      decisionNote,
      ...(additionalBudgetCents != null ? { additionalBudgetCents } : {}),
    }),
